...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, Object(__WEBPACK_IMPORTED_MODULE_2_vuex__["c" /* mapState */])({
    ...
    sysInfo: function sysInfo(state) {
      return state.global.systemInfo;
    }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "chat",
    style: ({
      paddingBottom: _vm.isIphoneX ? (_vm.safeBottom + 70) + 'px' : '70px'
    }),
    attrs: {
      "id": "chat",
      "eventid": '36'
    ...
    class: {
      'input-focus': _vm.focusedInput === 'data'
    },
    attrs: {
      "type": "text",
      "placeholder": "输入数据",
    ...
    staticClass: "custom-input",
    class: {
      'input-focus': _vm.focusedInput === 'desc'
    },
    attrs: {
      "type": "text",
      "placeholder": "输入描述",
    ...
    staticClass: "custom-input",
    class: {
      'input-focus': _vm.focusedInput === 'ext'
    },
    attrs: {
      "type": "text",
      "placeholder": "输入其他",
    ...
    staticClass: "bottom",
    style: ({
      paddingBottom: _vm.isIphoneX ? _vm.safeBottom + 'px' : ''
    })
  }, [_c('div', {
    staticClass: "bottom-div",
    style: ({
      marginBottom: _vm.isFocus ? '10px' : 0
    })
  }, [_c('div', {
